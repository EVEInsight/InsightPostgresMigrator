...
def run_integrity_checks():
    ...
    migration_check_integrity("contacts_alliances", ["alliance_id, token"])
    migration_check_integrity("contacts_characters", ["character_id", "token"])
    migration_check_integrity("contacts_corporations", ["corporation_id", "token"])
